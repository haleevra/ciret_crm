...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	//ТекстЗапроса = СхемаКомпоновкиДанных.НаборыДанных.МаржаПоКлиентамСУчетомБонусов.Запрос;
	...
	//СхемаКомпоновкиДанных.НаборыДанных.МаржаПоКлиентамСУчетомБонусов.Запрос = ТекстЗапроса;	
